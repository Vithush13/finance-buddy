...
export default function CustomBarChart({data}){
    ...
    const getBarColor= (index)=>{
        return index % 2=== 0? "#476cf2ff": "#7796f5ff";
    };
        ...
        if (active && payload && payload.length ){
            return(
                <div className="bg-white shadow-md rounded-lg p-2 border border-gray-300">
                    <p className="text-xs font-semibold text-blue-800 mb-1">{payload[0].payload.label}</p>
        ...
        <div className="bg-white mt-6">
            <ResponsiveContainer width="100%" height={300}>
                <BarChart data={data}>
                    ...
                    <Bar dataKey="amount" fill="#ff8842" radius={[10, 10,0,0]}
